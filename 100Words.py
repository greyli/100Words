...
def blog_command():
    webbrowser.open("http://withlihui.com")


def detail_command():
    webbrowser.open("https://github.com/lihuii/100Words")
...
def time_counter():
    ...
    counter.title("Time")
    counter.geometry("160x100+1300+200")
...
def translate_word():
    ...
    translate_top.geometry("200x300+1300+400")
...
helpmenu.add_command(label="My Blog", command=blog_command)
